...
object RestrictableChooseConstraintGen {
  ...
  /**
    ...
    */
  def visitRestrictableChoose(exp: KindedAst.Expr.RestrictableChoose)(implicit declSym: Symbol, c: TypeContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
  ...
  /**
    ...
    */
  def visitApplyRestrictableTag(exp: KindedAst.Expr.RestrictableTag)(implicit declSym: Symbol, scope: Scope, c: TypeContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
    exp match {
  ...
  /**
    ...
    */
  def visitOpenAs(exp0: KindedAst.Expr.OpenAs)(implicit declSym: Symbol, c: TypeContext, root: KindedAst.Root, flix: Flix): (Type, Type) = {
    implicit val scope: Scope = c.getScope
    exp0 match {
